...
<div class="flex items-center justify-center py-12 px-4">
    ...
    <div class="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-10 animate-fadeIn">
        <div class="flex items-center justify-center gap-3 mb-2">
            ...
            <h2 class="text-3xl font-bold text-center text-[#1d3557]">Edit Study Task</h2>
        </div>
        ...
        <form action="{{ route('study_tasks.update', $task->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input
                    ...
                    name="title"
                    id="title"
                    placeholder="Contoh: Revisi Laporan, Belajar Framework, dll"
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none">{{ old('description', $task->description) }}</textarea>
            </div>
